...
> 1. Un documento (en formato DOCX y PDF) que contenga:
...
> 2. Los archivos de proyecto en Visual Paradigm con los diseños UML.
> 3. Código Java generado a partir de los diagramas UML, almacenado en un repositorio de GitHub, y evidencia del uso de control de versiones (Todos los integrantes deben aportar al proyecto de manera equitativa).
...
- [x] **Leer y analizar** detenidamente los antecedentes del sistema HomeStay
- [x] **Identificar** los actores principales del sistema
- [x] **Definir** las funcionalidades clave del sistema
...
- [x] **Diseñar** diagrama de casos de uso con todos los actores y relaciones
- [x] **Incluir** al menos 2 refinamientos `includes` y 2 `extends`
- [x] **Documentar** las asunciones del proyecto
- [x] **Seleccionar** 4 casos de uso principales
- [x] **Detallar** cada caso de uso con:
  - [x] Actores involucrados
  - [x] Precondiciones
  - [x] Flujo principal de eventos
  - [x] Flujos alternativos
  - [x] Postcondiciones

## 🏗️ Fase 3: Diagrama de Clases (Sección B - 30%)
- [x] **Identificar** clases, atributos y métodos principales
- [x] **Aplicar principios SOLID** en el diseño:
  - [x] **S** - Principio de responsabilidad única
  - [x] **O** - Principio abierto/cerrado
